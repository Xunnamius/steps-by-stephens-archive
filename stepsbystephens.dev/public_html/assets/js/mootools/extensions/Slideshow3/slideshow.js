...
(function(){
	...
	*/
		...
		initialize: function(el, data, options){
			...
			this.height = function(){ return this.options.height || images.getDimensions().y; };	
			this.width = function(){ return this.options.width || images.getDimensions().x; };
